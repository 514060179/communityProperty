<template>
	<view class="select-single-resource">
		<view class="resource-header flex justify-between bg-white">
			<view class="text-bold">{{cName}}</view>
			<view>
		...
		<select-resource @getResourceInfo="_getResourceInfo" ref="selectresource" :resOrderType="resOrderType"
			:shType="shType"></select-resource>
	</view>
</template>
