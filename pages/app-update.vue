				...
				<view class="popup-bg">
					<view class="popup-content" :class="{'popup-content-show' : popup_show}">
						<view class="update-wrap">
							<image src="../components/yzhua006-update/images/img.png" class="top-img"></image>
							<view class="content">
						...
						<image src="../components/yzhua006-update/images/close.png" class="close-ioc"
							@click="closeUpdate()" v-if="downstatus < 1 && update_info.force == 0"></image>
					</view>
				</view>
			</view>
		</view>
