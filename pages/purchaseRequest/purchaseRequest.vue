		...
		<view class="">
			...
			<form class="disabled">
				<view class="cu-list menu ">
					<view class="cu-item arrow" @tap="_selectFloor()">
						<view class="content">
							<text class="text-grey">采购类型</text>
						</view>
						<view class="action">
							<text class="text-grey text-sm">{{floorNum != ''?floorNum:'请选择'}}</text>
						</view>
					</view>
				</view>
			...
			<form>
				...
				<view class="cu-form-group align-start">
					...
					<textarea maxlength="-1" :disabled="modalName!=null" @input="textareaBInput" v-model="explainPuchase" placeholder="申请采购说明"></textarea>
				</view>
			</form>
	...
	export default {
		...
		onShow() {
			...
			if (_floorInfo) {
				...
				this.floorNum = this.typeName = _floorInfo.resName;
