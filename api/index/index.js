...
import apiUrl from '@/constant/url.js'
 ...
 */
export function loadAdvert(_that, _data, isShowLoad) {
 ...
 * @param {Object} _that 上下文对象
 */
export function listStaffPrivileges(isShowLoad) {
	return new Promise(function(reslove, reject) {
		context.get({
			url: apiUrl.listStaffPrivileges,
			data: {
				a: '123'
			}, //动态数据
			success: function(res) {
 ...
 * 查询首页 目录
 */
export function loadCategoryMenus(_that, _data, isShowLoad) {
	return new Promise(function(reslove, reject) {
		_that.context.get({
 ...
 */
export function loadActivitys(_that, _data, isShowLoad) {
	return new Promise(function(reslove, reject) {
		_that.context.get({
 ...
 * @param {Object} _data
 */
export function queryUndoCount(_that, _data, isShowLoad) {
	return new Promise(function(reslove, reject) {
		_that.context.get({
