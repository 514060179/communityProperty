...
export default {
	...
	getAppVersion: baseUrl + 'app/app.getAppVersion', //版本升級
	uploadUserPhoto: baseUrl + 'app/user.uploadUserPhoto', //修改物業頭像
	getUserInfo: baseUrl + 'app/user.getUserInfo', //查詢物業頭像
